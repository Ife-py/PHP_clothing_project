-- declaring the name of the place holder for  database
CREATE DATABASE `shirts4mike` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
-- calling the created database placeholder
USE `shirts4mike`;
-- declaring tables and the type of characters they will include
...
-- parsing data into the tables id created 
...
-- all these codes will be run on the php local mysql where the tables will be created